        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Visibility(
                visible: GSA,
                child: Answer(message: 'Hello There! \nHow can I help you?'),
              ), //
              ...
              Visibility(
                visible: v2,
                child: send(
                  message: 'Types of color blindness',
                  function: () {
                    setState(() {
                      x = true;
                      v2A = true;
              ...
              Visibility(
                visible: v21,
                child: send(
                  message: 'Red-green color blindness',
                  function: () {
                    setState(() {
                      v21A = true;
                      v211 = true;
              ...
              Visibility(
                ...
                child: Answer(
                    message:
                        'Deuteranomaly (aka green-weak) is the most common type of red-green color blindness. It makes the green look more red.'),
              ), //q2.1.1 answer
